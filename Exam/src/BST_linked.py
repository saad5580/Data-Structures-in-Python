...
class BST:
    ...
    # In this function, any node being passed to this function, tree is turn
    # to right around that node.
    def _turn_right(self, parent):
        ...
        -------------------------------------------------------
        """
        # rotate the tree to the right using left rotation

        y = parent._right  # To keep track of parent node
        T2 = y._left
        y._left = parent
        parent._right = T2
    ...
    def _max_height_aux(self, node):
        ...
        ---------------------------------------------------------
        """
        # return the max height of the given node
